...
public class EfTxImageCaptionBehavior<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse>
where TRequest : notnull, IRequest<TResponse>
where TResponse : notnull
{
    private readonly ILogger<EfTxImageCaptionBehavior<TRequest, TResponse>> _logger;
    ...
    public EfTxImageCaptionBehavior(
        ILogger<EfTxImageCaptionBehavior<TRequest, TResponse>> logger,
