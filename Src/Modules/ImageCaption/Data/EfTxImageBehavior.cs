...
public class EfTxImageBehavior<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse>
where TRequest : notnull, IRequest<TResponse>
where TResponse : notnull
{
    private readonly ILogger<EfTxImageBehavior<TRequest, TResponse>> _logger;
    private readonly ImageDbContext _dbContext;
    private readonly IPersistMessageDbContext _persistMessageDbContext;
    private readonly IEventDispatcher _eventDispatcher;

    public EfTxImageBehavior(
        ILogger<EfTxImageBehavior<TRequest, TResponse>> logger,
