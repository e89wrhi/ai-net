...
public class EfTxResumeBehavior<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse>
where TRequest : notnull, IRequest<TResponse>
where TResponse : notnull
{
    private readonly ILogger<EfTxResumeBehavior<TRequest, TResponse>> _logger;
    private readonly ResumeDbContext _dbContext;
    private readonly IPersistMessageDbContext _persistMessageDbContext;
    private readonly IEventDispatcher _eventDispatcher;

    public EfTxResumeBehavior(
        ILogger<EfTxResumeBehavior<TRequest, TResponse>> logger,
