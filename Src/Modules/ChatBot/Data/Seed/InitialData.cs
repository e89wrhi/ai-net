...
public static class InitialData
{
    ...
    static InitialData()
    {
        ...
        Chats[0].AddMessage(MessageModel.Create(MessageId.Of(Guid.NewGuid()), sessionId1, MessageSender.Of(ChatBot.Enums.MessageSender.System.ToString()), MessageContent.Of("AI stands for Artificial Intelligence..."), TokenUsed.Of(50)));
        ...
        Chats[1].AddMessage(MessageModel.Create(MessageId.Of(Guid.NewGuid()), sessionId2, MessageSender.Of(ChatBot.Enums.MessageSender.System.ToString()), MessageContent.Of("To make a pizza, you need dough, sauce..."), TokenUsed.Of(100)));
    }
}