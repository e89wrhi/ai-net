...
public record SynthesizeSpeechCommand(Guid UserId, string Text, VoiceType Voice, SpeechSpeed Speed, string Language, string? ModelId = null) : ICommand<SynthesizeSpeechCommandResult>;
