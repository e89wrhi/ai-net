...
public class EfTxLearningBehavior<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse>
where TRequest : notnull, IRequest<TResponse>
where TResponse : notnull
{
    private readonly ILogger<EfTxLearningBehavior<TRequest, TResponse>> _logger;
    private readonly LearningDbContext _dbContext;
    private readonly IPersistMessageDbContext _persistMessageDbContext;
    private readonly IEventDispatcher _eventDispatcher;

    public EfTxLearningBehavior(
        ILogger<EfTxLearningBehavior<TRequest, TResponse>> logger,
