...
public class EfTxAssistantBehavior<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse>
where TRequest : notnull, IRequest<TResponse>
where TResponse : notnull
{
    private readonly ILogger<EfTxAssistantBehavior<TRequest, TResponse>> _logger;
    ...
    public EfTxAssistantBehavior(
        ILogger<EfTxAssistantBehavior<TRequest, TResponse>> logger,
