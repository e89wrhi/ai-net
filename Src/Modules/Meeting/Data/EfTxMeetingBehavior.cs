...
public class EfTxMeetingBehavior<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse>
where TRequest : notnull, IRequest<TResponse>
where TResponse : notnull
{
    private readonly ILogger<EfTxMeetingBehavior<TRequest, TResponse>> _logger;
    private readonly MeetingDbContext _dbContext;
    private readonly IPersistMessageDbContext _persistMessageDbContext;
    private readonly IEventDispatcher _eventDispatcher;

    public EfTxMeetingBehavior(
        ILogger<EfTxMeetingBehavior<TRequest, TResponse>> logger,
