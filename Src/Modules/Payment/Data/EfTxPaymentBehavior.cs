...
public class EfTxPaymentBehavior<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse>
where TRequest : notnull, IRequest<TResponse>
where TResponse : notnull
{
    private readonly ILogger<EfTxPaymentBehavior<TRequest, TResponse>> _logger;
    private readonly PaymentDbContext _dbContext;
    private readonly IPersistMessageDbContext _persistMessageDbContext;
    private readonly IEventDispatcher _eventDispatcher;

    public EfTxPaymentBehavior(
        ILogger<EfTxPaymentBehavior<TRequest, TResponse>> logger,
